...
const Card = React.forwardRef<HTMLDivElement, CardProps>(
  (
    ...
    const variants = {
      ...
      bordered: 'bg-white rounded-2xl border-2 border-amber-100 shadow-sm',
    ...
    return (
      <div
        ...
        className={cn(
          variants[variant],
          paddings[padding],
          hoverable && 'transition-all duration-300 hover:border-amber-200 hover:shadow-card-hover cursor-pointer hover:-translate-y-0.5',
          className
        )}
        {...props}
      >
