            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`
                  ...
                  ${
                    activeTab === tab.id
                      ? 'bg-white text-indigo-700 font-semibold rounded-lg px-4 py-2 shadow-sm'
              ...
              <CardContent>
                <form onSubmit={handleProfileUpdate} className="space-y-4">
                  <div>
                    ...
                    <input
                      className="w-full px-4 py-2.5 bg-white border border-gray-200 text-gray-900 placeholder-gray-400 rounded-xl focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 outline-none transition-all"
                  ...
                  <button
                    type="submit"
                    disabled={isUpdating}
                    className="bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-xl px-6 py-2.5 font-medium hover:from-indigo-500 hover:to-violet-500 transition-all disabled:opacity-50"
                  >
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-card p-6 mb-6">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                {user.planType !== 'TIER2' && (
                  <Link href="/pricing">
                    <button className="bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-xl px-6 py-2.5 font-medium hover:from-indigo-500 hover:to-violet-500 transition-all">
                      Upgrade Plan
                    </button>
                  </Link>
                )}
              ...
              {!usageStats ? (
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="w-full bg-gray-100 rounded-full h-2">
                      <div
                        className="bg-gradient-to-r from-violet-400 to-violet-500 h-2 rounded-full transition-all"
                        style={{
                          width:
                            user.planType === 'FREE'
                              ? `${getUsagePercentage(
