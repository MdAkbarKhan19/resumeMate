...
/**
 * Enhanced DOCX Export Endpoint
 * Generates editable Word document that's ATS-friendly
 */
async function handler(
  ...
  try {
    ...
    // Generate DOCX using enhanced service
...
export const maxDuration = 60; // Allow up to 60 seconds for DOCX generation
