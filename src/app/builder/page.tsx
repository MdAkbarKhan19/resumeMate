    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-20">
        <div className="max-w-[1600px] mx-auto px-4 py-3">
          ...
          <div className="flex gap-1 mt-3 overflow-x-auto pb-1 -mb-3 border-b-0">
        ...
        <div className="flex gap-6">
          ...
          <div className={`flex-1 min-w-0 space-y-6 ${showPreview ? 'lg:max-w-[55%]' : ''}`}>
            ...
            {customSections.map(section => (
              <SectionCard key={section.id} title={section.title} sectionKey={section.id} isComplete={!!section.content}>
                <div className="space-y-3">
