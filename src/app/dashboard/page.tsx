      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Card variant="elevated">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                ...
                <div className={`w-12 h-12 ${user.subscriptionActive ? 'bg-green-100' : 'bg-gray-100'} rounded-lg flex items-center justify-center`}>
                  <svg
                    className={`w-6 h-6 ${user.subscriptionActive ? 'text-green-600' : 'text-gray-600'}`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
        ...
        <Card className="mb-8 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-xl font-bold">ATS Resume Optimizer</h3>
              ...
              {recentResumes.length > 0 ? (
                <Link href={`/builder/ats?resumeId=${recentResumes[0].id}`}>
                  <Button
                    variant="outline"
                    size="lg"
                    className="bg-white text-indigo-600 border-white hover:bg-indigo-50 font-semibold"
                  >
                    Optimize Resume
                  </Button>
                </Link>
                        ...
                        <div className="mt-3 pt-3 border-t border-gray-200">
                          <div className="flex items-center flex-wrap gap-3 text-xs text-gray-600">
                            ...
                            {resume.certifications && resume.certifications.length > 0 && (
                              <div className="flex items-center">
                                <svg className="w-4 h-4 mr-1 text-pink-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
